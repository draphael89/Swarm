      ...
      >
        ...
        {isLoadingTelegram || !telegramDraft ? (
          ...
          <div className="space-y-3">
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              <ToggleRow label="Allow image attachments" description="Ingest Telegram image uploads as Swarm attachments." checked={telegramDraft.allowImages} onChange={(next) => setTelegramDraft((prev) => (prev ? { ...prev, allowImages: next } : prev))} />
